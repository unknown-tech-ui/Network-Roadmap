...
- **A Linux VM**: [Kali Linux](https://www.kali.org/get-kali/#kali-virtual-machines) (pre-loaded with most security tools used this week) or plain [Ubuntu Desktop](https://ubuntu.com/download/desktop) if you'd rather install tools yourself
...
- Browser DevTools again (Network + Console tabs this time for the XSS/SQLi walkthroughs).

## Day 3 — Cryptography Basics

- **[CyberChef](https://gchq.github.io/CyberChef/)** — runs entirely in-browser, no install. Bookmark it.
- No command line needed today.

## Day 4 — Web PKI & TLS

- Just a browser — you'll be inspecting real certificates via the padlock icon and visiting [badssl.com](https://badssl.com/) and [SSL Labs](https://www.ssllabs.com/ssltest/).
- **Optional (bonus capture exercise)**: [Wireshark](https://www.wireshark.org/download.html)
  ```bash
...
- Everything from Days 1–6: browser + DevTools, CyberChef, Nmap, and your VM.
...
- The pre-made "spoofed vs normal DNS" packet capture file (Day 5)
- The 3 pre-hashed weak passwords for the Day 3 challenge
- The model answer sheet for the Day 6 Nmap report
